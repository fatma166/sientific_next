...
import { useGetClientLastWatchedBooksQuery } from "@/services/api/books"
import { useLanguage } from "@/services/hooks"
import { Empty, Pagination } from "antd"
import React, { useState } from 'react'

const MainBookshelfLastWatchedPage = () => {
    ...
    <div>
      <RevealAnimation>
        ...
        <div className="container  py-10 lg:py-12">
          ...
          <div className="mb-9">
            <h2 className="text-xl font-bold">  {t('last_watched')} </h2>
          </div>
...
const Content = ({ }) => {
  ...
  const { data, isLoading, error, refetch } = useGetClientLastWatchedBooksQuery({ page })
...
export default MainBookshelfLastWatchedPage